            ...
            <div className="h-full w-96 bg-slate-50 border-r flex flex-col">
                ...
                <div className="h-full">
                    ...
                    <div
                        ...
                        <div className="ml-4">
                            <p className="text-md font-semibold text-slate-600 m-0 p-0">Yaroslav Zubkp
                            </p>
                            <p className="text-xs text-slate-400 -mt-0.5 font-semibold">is is long ipsum
                                avaliable...</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <img
                            ...
                            className="h-12 w-12 border-2 border-white rounded-full" alt=""/>
                        <div className="ml-4">
                            <p className="text-md font-semibold text-slate-600 m-0 p-0"> Alison Alison
                            </p>
                            <p className="text-xs text-slate-400 -mt-0.5 font-semibold">Hello</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <img
                            ...
                            className="h-12 w-12 border-2 border-white rounded-full" alt=""/>
                        <div className="ml-4">
                            <p className="text-md font-semibold text-slate-600 m-0 p-0"> Mircel Jones</p>
                            <p className="text-xs text-slate-400 -mt-0.5 font-semibold">Ok, Thanks.</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <img
                            ...
                            className="h-12 w-12 border-2 border-white rounded-full" alt=""/>
                        <div className="ml-4">
                            <p className="text-md font-semibold text-slate-600 m-0 p-0">Uran Poland</p>
                            <p className="text-xs text-slate-400 -mt-0.5 font-semibold">We own hidden
                                lake..</p>
                        </div>
                    </div>
                ...
                <div className="h-16 border-b flex justify-between items-center w-full px-5 py-2 shadow-sm">
                    ...
                    <div className="flex items-center space-x-5">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             className="h-9 bg-slate-50 rounded-full stroke-slate-400 p-2" fill="none"
                             viewBox="0 0 24 24"
                        ...
                        <div className="w-1/2">
                            ...
                            <div className="mt-3 w-full bg-slate-50 p-4 rounded-b-xl rounded-tr-xl">
                                <p className=" text-sm text-slate-500">
                                    Hey all, <br/>
                                    There are many variation of passages of Lorem ipsum avaliable, but the
                                    jority have alternation in some form , by injected humor, or randomise words
